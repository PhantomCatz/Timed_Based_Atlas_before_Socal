...
public final class CatzConstants {
 ...
 //Saving for finished trajectory planner
  ...
  public static final class DriveConstants
  {
    ...
    public static final double NOT_FIELD_RELATIVE = 0.0;
  ...
  public static final class IntakeConstants 
  {
    ...
    public static final double INTAKE_ENC_TO_INTAKE_GEAR_RATIO =  46.0/18.0;
    ...
    public static final double INTAKE_CONE_ENC_POS_GROUND =  -184.524 + INTAKE_WRIST_ABS_ENC_OFFSET_DEG;//-306.0  + WRIST_ABS_ENC_OFFSET;  //-1295  
    public static final double INTAKE_CONE_ENC_POS_SINGLE =  -116.400 + INTAKE_WRIST_ABS_ENC_OFFSET_DEG;//2089.0 + WRIST_ABS_ENC_OFFSET;  //1100

    public static final double INTAKE_SCORE_CUBE_ENC_POS         =  -104.000 + INTAKE_WRIST_ABS_ENC_OFFSET_DEG;//1859.0 + WRIST_ABS_ENC_OFFSET;  //870     // Applies to low-mid-high

    public static final double INTAKE_SCORE_CONE_HIGH_ENC_POS    =  -153.000 + INTAKE_WRIST_ABS_ENC_OFFSET_DEG;//289.0 + WRIST_ABS_ENC_OFFSET;  //-700
    public static final double INTAKE_SCORE_CONE_MID_ENC_POS     = INTAKE_CONE_ENC_POS_GROUND; //TBD verify if its the same as high
    public static final double INTAKE_SCORE_CONE_LOW_ENC_POS     = INTAKE_CONE_ENC_POS_GROUND; //TBD
    ...
    public static final double ERROR_INTAKE_THRESHOLD_DEG = 5.0;
