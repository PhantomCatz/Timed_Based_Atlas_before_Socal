 ...
 * 
 * Interfaces can essentially be used for two things: serve as a basis of a class or used as a collection of methods whose actions are determined on instantiation. 
 */
